...
const ReviewForm = () => {
            ...
            >
              <span
                style={{ 
                  ...
                  fontSize: '32px',
                  filter: star <= (hoverRating || value) ? 'drop-shadow(0 0 3px rgba(255,215,0,0.7))' : 'none',
                  transition: 'all 0.3s ease'
                }}
              >
                ★
  ...
  return (
    <div className="card" style={{ borderRadius: "12px", overflow: "hidden", boxShadow: "0 5px 15px rgba(0,0,0,0.1)" }}>
      <div className="card-header text-center" style={{ background: "linear-gradient(45deg, #2193b0, #6dd5ed)", color: "white", padding: "15px" }}>
        <h5 className="card-title mb-0">השאר משוב</h5>
      </div>
      <div className="card-body" style={{ padding: "25px" }}>
        <form onSubmit={handleReviewSubmit}>
          <div className="mb-4 mt-3">
            <label className="form-label d-block text-center mb-4">כיצד היית מדרג את החוויה שלך?</label>
          ...
          <div className="text-center">
            <button 
              ...
              style={{
                ...
                borderRadius: "30px",
                border: "none",
                boxShadow: "0 3px 10px rgba(33, 147, 176, 0.3)",
                transition: "all 0.3s ease",
